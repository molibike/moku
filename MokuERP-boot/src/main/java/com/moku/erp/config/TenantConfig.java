...
public class TenantConfig {
    ...
    public PaginationInterceptor paginationInterceptor(HttpServletRequest request) {
        ...
        paginationInterceptor.setSqlParserFilter(new ISqlParserFilter() {
            ...
            public boolean doFilter(MetaObject metaObject) {
                ...
                // 过滤自定义查询此时无租户信息约束出现
                if ("com.moku.erp.datasource.mappers.UserMapperEx.getUserByWeixinOpenId".equals(ms.getId())) {
                    return true;
                } else if ("com.moku.erp.datasource.mappers.UserMapperEx.updateUserWithWeixinOpenId".equals(ms.getId())) {
                    return true;
                } else if ("com.moku.erp.datasource.mappers.UserMapperEx.getUserListByUserNameOrLoginName".equals(ms.getId())) {
                    return true;
                } else if ("com.moku.erp.datasource.mappers.UserMapperEx.disableUserByLimit".equals(ms.getId())) {
                    return true;
    ...
    /**
     * 相当于顶部的：
     * {@code @MapperScan("com.moku.erp.datasource.mappers*")}
     * 这里可以扩展，比如使用配置文件来配置扫描Mapper的路径
     */
    @Bean
    public MapperScannerConfigurer mapperScannerConfigurer() {
        MapperScannerConfigurer scannerConfigurer = new MapperScannerConfigurer();
        scannerConfigurer.setBasePackage("com.moku.erp.datasource.mappers*");
